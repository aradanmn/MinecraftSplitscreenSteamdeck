...
· **Active cycle:** v1.3 (virtual pad rig) — PR-2/PR-3/PR-4 all Deck-validated. PR-4 (#71 burst-spawn) closed 2026-08-02: 5/5 iterations converged, confirmed already fixed by existing code, no fix needed. PR-5 (#151) is next.

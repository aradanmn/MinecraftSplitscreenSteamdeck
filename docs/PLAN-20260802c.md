...
· **Active cycle:** v1.3 (virtual pad rig) — PR-2 (#197) Deck-validated; PR-3 (stage3_hotplug automation) **Deck-validated both modes 2026-08-02** — virtual (33/2/17) + human-mode regression check with real controllers (59/1/11, zero real regressions), two follow-ups filed (rig-cleanup pidfile bug, D3.2 cold-start timeout), two stale test-doc issues found and fixed

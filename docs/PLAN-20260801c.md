...
**Last updated:** 2026-08-01 (Sat afternoon, ~2:06pm) · **Repo:** `aradanmn/MinecraftSplitscreenSteamdeck`
· **Active cycle:** v1.2.4 shipped — v1.3 (virtual pad rig) starts next
...
| **v1.3** | Virtual pad rig. **Unblocked, starts next** — all ten probe verdicts green on hardware. |
